...
// 全局变量
const InputParam *globalInput;
IORequest requests[MAX_IO_REQUESTS];
uint32_t sequence[MAX_IO_REQUESTS];
uint32_t bestSequence[MAX_IO_REQUESTS];
double currentCost;
double bestCost = 1.79769313486231570814527423731704357e+308;

// 计算总代价
double calculateTotalCost(uint32_t *seq, uint32_t len) {
    double totalCost = 0;
